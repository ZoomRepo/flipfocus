...
export function WaitlistSignup() {
  ...
  return (
    <div className="w-full max-w-xl mx-auto p-8 flex flex-col justify-between min-h-screen">
      <div className="flex-1 flex flex-col justify-center items-center text-center" style={{ paddingLeft: '60px' }}>
        <div>
          <h2 className="text-4xl sm:text-5xl font-extrabold mb-8 bg-clip-text text-transparent bg-gradient-to-br from-gray-200 to-gray-600">
            Be Among the First
          </h2>
        </div>
        <div>
      ...
      <div className="pt-8 flex justify-center space-x-6" style={{position: 'absolute', bottom: '25%', left: '52%'}}>
        <SocialIcon
